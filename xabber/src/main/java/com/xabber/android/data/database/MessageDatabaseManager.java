...
public class MessageDatabaseManager {
    ...
    static final int REALM_MESSAGE_DATABASE_VERSION = 18;
    ...
    @RealmModule(classes = {MessageItem.class, SyncInfo.class, Attachment.class, ForwardId.class,RedEnvelope.class})
        ...
        return new RealmConfiguration.Builder()
                ...
                .migration(new RealmMigration() {
                    ...
                    public void migrate(DynamicRealm realm1, long oldVersion, long newVersion) {
                        ...
                        if(oldVersion == 17){
                            schema.create(RedEnvelope.class.getSimpleName())
                                    .addField("uniqueId", String.class,
                                            FieldAttribute.PRIMARY_KEY, FieldAttribute.REQUIRED)
                                    .addField(RedEnvelope.Fields.RED_ENVELOPE_MONEY, String.class)
                                    .addField(RedEnvelope.Fields.RED_ENVELOPE_REMARKS, String.class)
                                    .addField(RedEnvelope.Fields.RED_ENVELOPE_RECEIVE, boolean.class);

                            schema.get(MessageItem.class.getSimpleName())
                                    .addField(MessageItem.Fields.MESSAGETYPE, Integer.class)
                                    .addField(MessageItem.Fields.REVOKE, boolean.class)
                                    .addRealmListField(MessageItem.Fields.REDENVELOPES,schema.get(RedEnvelope.class.getSimpleName()));
                            oldVersion++;
                        }
