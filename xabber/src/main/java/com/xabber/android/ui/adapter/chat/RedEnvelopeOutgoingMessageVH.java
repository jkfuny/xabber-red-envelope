...
public class RedEnvelopeOutgoingMessageVH extends OutgoingMessageVH {
    TextView tvRemaks;
    RedEnvelopeOutgoingMessageVH(View itemView, MessageClickListener messageListener, MessageLongClickListener longClickListener, FileListener fileListener, int appearance) {
