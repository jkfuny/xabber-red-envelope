...
public class FileMessageVH extends MessageVH
    ...
    protected View redEnvelopeLayout;
    ...
    public interface FileListener {
        ...
        void onRedEnvelopeClick(int messagePosition,int redEnvelopePosition, String messageUID);
    }
    ...
    public FileMessageVH(View itemView, MessageClickListener messageListener,
        ...
        redEnvelopeLayout = itemView.findViewById(R.id.redenvelopLayout);
        ...
        if(redEnvelopeLayout!=null) {
            redEnvelopeLayout.setOnClickListener(this);
        }
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.ivCancelUpload:
                ...
                break;
            case R.id.redenvelopLayout:
                listener.onRedEnvelopeClick(adapterPosition,0, messageId);
                break;
            default:
                super.onClick(v);
        }
        ...
        if (progressData != null && messageId.equals(progressData.getMessageId())) {
            if (progressData.isCompleted()) {
                ...
                if (uploadProgressBar != null)
                    uploadProgressBar.setProgress(progressData.getProgress());
